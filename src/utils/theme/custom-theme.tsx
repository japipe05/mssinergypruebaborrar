...
const customTheme = {
  ...
  badge: {
    root: {
      ...
      color: {
        ...
        white: "bg-white dark:bg-darkmuted text-dark dark:text-white dark:bg-darkgray",
        ...
        lightgraysubtle: "bg-lightbg dark:bg-darkbody text-body dark:text-darkmuted",
  ...
  drawer: {
    ...
    header: {
      inner: {
        closeButton:
          "absolute end-2.5 top-3 flex h-8 w-8 items-center justify-center rounded-lg bg-lightgray dark:bg-darkbody text-primary",
        closeIcon: "h-4 w-4",
        titleText:
          "mb-4 inline-flex items-center text-base font-semibold text-bodyclr dark:text-darkmuted",
      },
    },
  },
  ...
  Dropdown: {
    ...
    floating: {
      ...
      content: "py-2 text-sm text-bodyclr dark:text-darkmuted ",
      header:
        "block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 items-center",
      item: {
        base: "flex w-full cursor-pointer items-center justify-start px-4  py-2 text-sm text-bodyclr dark:text-darkmuted bg-hover  focus:bg-hover focus:outline-none ",
      },
      style: {
  ...
  table: {
    ...
    head: {
      base: "group/head text-sm font-medium capitalize text-dark dark:text-darkmuted border-0",
      cell: {
  ...
  accordion: {
    ...
    content: {
      base: "p-5 first:rounded-t-lg last:rounded-b-lg text-sm text-bodyclr dark:text-darkmuted",
    },
    title: {
      arrow: {
  ...
  tabs: {
    ...
    tablist: {
      ...
      styles: {
        default: "flex-wrap border-b border-border dark:border-darkborder",
        underline:
          "-mb-px flex-wrap border-b border-border dark:border-darkborder ",
  ...
  navbar: {
    ...
    link: {
      base: "text-base py-1.5 px-4 hover:text-primary text-bodyclr dark:text-darkmuted dark:text-darkmuted dark:hover:text-primary hover:bg-lightprimary font-medium rounded-full flex justify-center items-center cursor-pointer ",
      active: {
  ...
  toggleSwitch: {
    ...
    toggle: {
      ...
      checked: {
        ...
        off: "border-border bg-gray-200 dark:border-gray-600 dark:bg-gray-700",
        color: {
  ...
  popover: {
    ...
    arrow: {
      base: "absolute h-2 w-2 z-0 rotate-45 rounded-md mix-blend-lighten bg-white border border-border dark:border-gray-600 dark:bg-gray-800 dark:mix-blend-color",
  ...
  sidebar: {
    ...
    label: {
      "base": "flex-1 whitespace-nowrap text-right ml-0",
      "icon": {
  ...
  timeline: {
    root: {
      direction: {
        horizontal: "sm:flex",
        vertical: "relative border-l border-border dark:border-darkborder",
      },
    },
    item: {
      root: {
  ...
  listGroup: {
    root: {
      base: "list-none rounded-lg border border-border bg-white text-left text-sm font-medium text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white",
    },
    item: {
      base: "[&>*]:first:rounded-t-lg [&>*]:last:rounded-b-lg [&>*]:last:border-b-0",
      link: {
        base: "flex w-full items-center border-b border-border px-4 py-2 dark:border-gray-600",
        active: {
