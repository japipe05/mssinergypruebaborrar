...
import bg3 from '/public/images/blog/blog-img7.jpg';
...
const Activity = () => {
  return (
      <CardBox className='mb-0 p-0'>
       <div className="md:flex items-center mb-0 p-6">
    ...
    <div className='analytical-activity z-[3] p-6 border-t border-border dark:border-darkborder relative after:absolute after:start-[44px] after:z-1 after:top-0 after:w-[1px] after:bg-border dark:after:bg-darkborder after:h-full'>
      {/* row 1 */}
      ...
      <Badge color="lightsubtle" className="bg-lightgray dark:bg-body absolute translate-middle px-4 leading-none py-0.5 -top-[13px] z-10 start-[18px] text-sm font-normal">
            Today
        </Badge>
    </div>
    <div className='analytical-activity z-[3] p-6 border-t border-border dark:border-darkborder relative after:absolute after:start-[44px] after:z-1 after:top-0 after:w-[1px] after:bg-border dark:after:bg-darkborder after:h-full'>
      ...
      <div className="flex align-items-start mt-4">
        ...
        <div className="ms-3 mt-1">
          ...
          <p className='mt-3 font-medium text-muted dark:text-darkmuted'>It has survived not only five centuries, but also the leap into
          electrotypesetting, remaining essentially unchanged.</p>
        </div>
      </div>
      <div className="flex align-items-start mt-4">
        <span className='relative z-5'>
          <Image src={user8} alt="user-5" className="rounded-full" width="45" />
        </span>
        <div className="ms-3 mt-1">
          <h5 className="mb-0 font-semibold text-sm text-dark">
          David R. Jones 
          ...
          <div className="flex items-center mt-4 mb-3">
            <Image src={bg1} alt="bg1" className='rounded-md' width="60" />
            <Image src={bg2} alt="bg2" className='rounded-md ms-2' width="60" />
            <Image src={bg3} alt="bg2" className='rounded-md ms-2' width="60" />
          </div>
        </div>
      </div>
      <Badge color="lightsubtle" className="bg-lightgray dark:bg-body absolute translate-middle px-4 leading-none py-0.5 -top-[13px] z-10 start-[18px] text-sm font-normal">
