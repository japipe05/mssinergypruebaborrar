...
const TransitionCode = () => {
  return (
    ...
    <div className="mx-auto w-full max-w-lg divide-y divide-border dark:divide-darkborder rounded-xl bg-lightgray dark:bg-dark">
        ...
        <DisclosurePanel
            transition
            className="mt-2 text-xs text-bodyclr dark:text-darkmuted font-medium origin-top transition duration-200 ease-out data-[closed]:-translate-y-6 data-[closed]:opacity-0"
        >
