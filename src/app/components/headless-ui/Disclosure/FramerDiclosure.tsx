                  ...
                  <AnimatePresence>
                    {open && (
                      <DisclosurePanel
                        ...
                        exit={{ opacity: 0, y: -24 }}
                        className="origin-top text-xs mt-2 text-bodyclr dark:text-darkmuted font-medium"
                      >
                  ...
                  <AnimatePresence>
                    {open && (
                      <DisclosurePanel
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -24 }}
                        className="origin-top text-xs text-bodyclr dark:text-darkmuted font-medium mt-2"
                      >
                        Lorem ipsum dolor sit amet, consectetur adipisici elit…’
                        (complete text) is dummy text that is not meant to mean
                        anything. It is used as a placeholder in magazine
