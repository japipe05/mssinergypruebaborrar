              ...
              <CardBox className="p-0 overflow-hidden ">
                ...
                <div className="px-6 pb-6">
                  <Image
                    ...
                    alt="user"
                  />
                  <Badge color={"muted"} className="mt-6 bg-graylight dark:bg-dark">
                    {item.category}
                  </Badge>
                  ...
                  <div className="flex">
                    <div className="flex gap-2 me-6 items-center">
                      ...
                      />{" "}
                      <span className="text-sm text-bodyclr dark:text-darkmuted">{item.view}</span>
                    </div>
                    ...
                    <div className="flex gap-1 items-center ms-auto">
                      <IconPoint
                        ...
                        className="text-dark dark:text-white"
                      />{" "}
                      <span className="text-sm text-bodyclr dark:text-darkmuted">{item.time}</span>
                    </div>
                  </div>
                </div>
              </CardBox>
