    ...
    <>
      <CardBox>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3 items-center">
            <div className="bg-lightbg dark:bg-darkbody h-10 w-10 flex justify-center items-center rounded-md">
            <IconGridDots size={20} className="text-bodyclr dark:text-darkmuted"/>
            </div>
            <div>
