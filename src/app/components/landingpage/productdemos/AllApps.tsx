  ...
  return (
    <>
      ...
      <div className="grid grid-cols-12 gap-6 mt-10">
        {DemosName.AppsDemos.map((item, index) => (
                ...
                <div className="relative overflow-hidden">
                    <div className="overflow-hidden rounded-md relative flex justify-center items-center group ">
                      <Image
                        ...
                        className="w-full"
                      />
                      <div className="absolute flex left-1/2 -translate-x-1/2 justify-center items-center  mx-auto invisible group-hover:visible z-[1]" >
                  ...
                  <div className="rounded-t-none rounded-md border-ld border-b  p-4">
                    ...
                    <p className="text-bodyclr dark:text-darkmuted mt-1">Demo</p>
                  </div>
                </div>
              </div>
          </React.Fragment>
