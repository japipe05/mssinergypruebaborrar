    ...
    <>
      ...
      >
        <div className="lg:hidden block p-6 pb-2">
          <Button color={"outlineprimary"} onClick={onCloseContact} className="py-0">
        ...
        <div className="w-full">
          <div className="flex justify-between items-center py-4 px-5">
            <h5 className="card-title font-semibold">Contact Details</h5>
                  ...
                  <div className="p-5">
                    <div className="flex gap-3 items-center">
                      ...
                      <div>
                        ...
                        <p className="text-bodyclr dark:text-darkmuted text-sm">
                    ...
                    <div className="grid grid-cols-12 gap-5 mt-8">
                      <div className="col-span-4">
                        <p className="text-bodyclr dark:text-darkmuted text-sm">Phone Number</p>
                        <h5 className="font-semibold mb-0.5">
                          {selectedContact.phone}
                        </h5>
                      </div>
                      <div className="col-span-8">
                        <p className="text-bodyclr dark:text-darkmuted text-sm">Email address</p>
                        <h5 className="font-semibold mb-0.5">
                          {selectedContact.email}
                        </h5>
                      </div>
                      <div className="col-span-12">
                        <p className="text-bodyclr dark:text-darkmuted text-sm">Address</p>
                        <h5 className="font-semibold mb-0.5">
                          {selectedContact.address}
                        </h5>
                      </div>
                      <div className="col-span-4">
                        <p className="text-bodyclr dark:text-darkmuted text-sm">Department</p>
                        <h5 className="font-semibold mb-0.5">
                          {selectedContact.department}
                        </h5>
                      </div>
                      <div className="col-span-8">
                        <p className="text-bodyclr dark:text-darkmuted text-sm">Company</p>
                        <h5 className="font-semibold mb-0.5">
                          {selectedContact.company}
                        </h5>
                      </div>
                      <div className="col-span-12">
                        <p className="text-bodyclr dark:text-darkmuted text-sm mb-1">Notes</p>
      ...
      {showAlert && (
        ...
        >
          <span className="ms-2">Contact updated successfully.</span>
        </Alert>
      )}
    </>
  );
