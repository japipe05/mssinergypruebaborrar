      ...
      <Tabs aria-label="Tabs with underline" variant="underline">
        <Tabs.Item active title="Discription">
          <div className="py-4">
            ...
            <p className="text-sm text-bodyclr dark:text-darkmuted font-medium">
              Cras eget elit semper, congue sapien id, pellentesque diam. Nulla
              faucibus diam nec fermentum ullamcorper. Praesent sed ipsum ut
              augue vestibulum malesuada. Duis vitae volutpat odio. Integer sit
              amet elit ac justo sagittis dignissim.
                ...
                <OutlineCard className="shadow-none">
                  <div className="flex flex-col gap-3 ">
                    <div className="flex items-center gap-5">
                      <span className="text-bodyclr dark:text-darkmuted text-xs">1 Stars</span>
                      <div className="grow ">
                    ...
                    <div className="flex items-center gap-5">
                      <span className="text-bodyclr dark:text-darkmuted text-xs">2 Stars</span>
                      <div className="grow ">
                    ...
                    <div className="flex items-center gap-5">
                      <span className="text-bodyclr dark:text-darkmuted text-xs">3 Stars</span>
                      <div className="grow ">
                    ...
                    <div className="flex items-center gap-5">
                      <span className="text-bodyclr dark:text-darkmuted text-xs">4 Stars</span>
                      <div className="grow ">
                    ...
                    <div className="flex items-center gap-5">
                      <span className="text-bodyclr dark:text-darkmuted text-xs">5 Stars</span>
                      <div className="grow ">
              ...
              <div className="lg:col-span-4 col-span-12 flex items-stretch">
                <OutlineCard className="shadow-none">
                  <div className="flex flex-col justify-center items-center py-5">
                    ...
                    >
                      <IconPencil size={22} /> write an review
                    </Button>
                  </div>
                </OutlineCard>
              </div>
