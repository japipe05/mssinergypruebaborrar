        ...
        {filteredAndSortedProducts.length > 0 ? (
          filteredAndSortedProducts.map((product) => (
            <div
              ...
              key={product.id}
            >
              <CardBox className="p-0 overflow-hidden group card-hover border border-border dark:border-darkborder">
                  ...
                  <div className="p-6 pt-4">
                    ...
                    <div className="flex justify-between items-center mt-1">
                      <h5 className="text-base flex gap-2 items-center">
                        ${product.price}{" "}
                        <span className="font-normal text-sm text-bodyclr dark:text-darkmuted line-through">
                          ${product.salesPrice}
                        </span>
                      </h5>
                      {product.rating == 5 ? (
            ...
            <div className="col-span-12">
              <div className="flex justify-center text-center">
                <div>
                  ...
                  <p className="text-bodyclr dark:text-darkmuted my-3">
