...
const ProductData = () => {
  ...
  return (
    <CardBox>
      <h5 className="card-title font-semibold mb-4">Product Details</h5>
      <div className="">
      ...
      <div className="mt-2">
        ...
        >
          <IconPlus size={18} /> Add selected category
        </Button>
      </div>
      ...
      <div className="mt-4">
        ...
        <div className="relative">
          <TextInput
            ...
            className="form-control"
          />
            <small className="text-xs text-bodyclr dark:text-darkmuted">Add tags for product.</small>
