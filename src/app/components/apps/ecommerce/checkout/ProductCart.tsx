                ...
                <Table.Cell className="whitespace-nowrap py-5 lg:min-w-auto min-w-[300px]">
                  <div className="flex gap-3 items-center ">
                    ...
                    <div className="">
                      ...
                      <p className="text-sm text-bodyclr dark:text-darkmuted mb-1">  {product.category}</p>
                      <IconTrash size={15} className="text-error cursor-pointer" onClick={() => removeFromCart(product.id)} />
                    </div>
                  </div>
                </Table.Cell>
