...
function InvoiceList() {
  ...
  return (
    <div className="overflow-x-auto">
      <div className="flex justify-between overflow-x-auto mb-8 gap-6 border-b border-ld pb-3">
        {/* Summary sections */}
        <div className="flex gap-3 items-center sm:w-3/12 w-full mb-2">
          ...
          <div>
            ...
            <p className="text-bodyclr dark:text-darkmuted">{invoices.length} invoices</p>
        ...
        <div className="flex gap-3 items-center sm:w-3/12 w-full mb-2">
          ...
          <div>
            ...
            <p className="text-bodyclr dark:text-darkmuted">{Shipped} invoices</p>
            <h6 className="text-sm">$23,110.23</h6>
          </div>
        </div>
        <div className="flex gap-3 items-center sm:w-3/12 w-full mb-2">
          <div className="h-14 w-14 rounded-full border-2 border-indigo text-indigo flex justify-center items-center">
            <Icon icon="solar:map-point-wave-linear" height={25} />
          </div>
          <div>
            <h5 className="text-base">Delivered</h5>
            <p className="text-bodyclr dark:text-darkmuted">{Delivered} invoices</p>
        ...
        <div className="flex gap-3 items-center sm:w-3/12 w-full mb-2">
          ...
          <div>
            ...
            <p className="text-bodyclr dark:text-darkmuted">{Pending} invoices</p>
      ...
      <div className="overflow-x-auto">
        <div className="flex gap-x-3 mt-10 border-b border-ld items-center">
          {/* Tabs */}
          <h3
            className={`text-base cursor-pointer flex items-center gap-2 text-ld border-b-2 pb-2 px-5 py-3 rounded-t-md ${activeTab === "All"
              ? "active bg-lightsubtle dark:bg-darkbody"
              : "border-transparent"
              }`}
          ...
          >
            ...
            <span
              className={` ${activeTab === "All"
                ...
                } h-6 w-6 rounded-sm block flex items-center justify-center text-sm `}
            >
              {invoices.length}
            </span>
          </h3>
          <h3
            className={`text-base cursor-pointer flex items-center gap-2 text-ld border-b-2 pb-2 px-5 py-3 rounded-t-md ${activeTab === "Shipped"
              ? "active bg-lightsubtle dark:bg-darkbody"
              : "border-transparent"
              }`}
          ...
          <h3
            className={`text-base cursor-pointer flex items-center gap-2 text-ld border-b-2 pb-2 px-5 py-3 rounded-t-md ${activeTab === "Delivered"
              ? "active bg-lightsubtle dark:bg-darkbody"
              : "border-transparent"
              }`}
          ...
          <h3
            className={`text-base cursor-pointer flex items-center gap-2 text-ld border-b-2 pb-2 px-5 py-3 rounded-t-md ${activeTab === "Pending"
              ? "active bg-lightsubtle dark:bg-darkbody"
              : "border-transparent"
              }`}
          ...
          <div>
            {selectAll ? (
              <Button color={"lightprimary"} className="btn-circle p-0" onClick={handleDelete}>
              ...
              <Table.Row key={invoice.id}>
                ...
                <Table.Cell>
                  {invoice.status === "Shipped" ? (
                    ...
                    <Badge color="indigo">{invoice.status}</Badge>
