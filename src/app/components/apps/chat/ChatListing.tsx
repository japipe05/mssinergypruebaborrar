      ...
      <div className="left-part w-full px-0 ">
        <div className="flex justify-between items-center px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-bodyclr dark:text-darkmuted text-xs">Marketing Director</p>
            </div>
          </div>
          <Dropdown
            label=""
        ...
        <SimpleBar className="max-h-[600px] h-[calc(100vh_-_100px)]">
          {filteredChats.map((chat) => (
            <div
              key={chat.id}
              className={`cursor-pointer py-4 px-6 gap-0 flex  group bg-hover ${
                activeChatId === chat.id
                  ? "bg-lighthover dark:bg-darkbody"
                  : "initial"
              }`}
