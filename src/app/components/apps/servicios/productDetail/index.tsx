...
import { ProductContext } from '@/app/context/Servicios/index';
import { useParams, usePathname } from "next/navigation";
import { ProductType } from '@/app/DashboardLayout/types/apps/servicios';
      ...
      {product ? (
        <>
          <div className="flex gap-2 items-center">
            ...
            <span className="text-xs text-bodyclr dark:text-darkmuted"> {product.category}</span>
          </div>
          ...
          <h5 className="text-xl flex gap-2 items-center my-3">
            <span className=" text-lg text-bodyclr dark:text-darkmuted line-through font-semibold">
              ${product.salesPrice}
            </span>
          ...
          <div className="flex items-center gap-5 mb-8">
            ...
            {product.colors.map((color) => (
              <div className="flex gap-3">
                ...
                >   {scolor === color ? <IconCheck className="text-white" size="1.1rem" /> : ''}</div>
              </div>
            ))}
          </div>
          {/* Qty */}
          ...
          <p className="text-sm text-bodyclr dark:text-darkmuted ">Dispatched in 2-3 weeks</p>
