      ...
      <div className="my-6">
        <div className="flex justify-between items-center mb-4">
          <Button
            ...
            className="bg-primary hover:bg-lightprimary hover:text-white rounded-lg"
          >
            Create Ticket
          </Button>
          <TextInput
              ...
              {visibleTickets.map((ticket) => (
                <Table.Row key={ticket.Id}>
                  ...
                  <Table.Cell className="max-w-md">
                    ...
                    <p className="text-sm text-bodyclr dark:text-darkmuted truncate line-clamp-1 text-wrap sm:max-w-56">
