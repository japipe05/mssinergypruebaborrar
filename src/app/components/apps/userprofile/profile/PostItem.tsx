        ...
        <div className="p-6 pb-0">
          <div className="flex items-center gap-3">
            ...
            <p className="flex items-center gap-2">
              <span className="h-[6px] w-[6px] font-medium rounded-full bg-dark opacity-40 dark:bg-white block"></span>
              {post?.profile.time}
            </p>
          </div>
          {/**Post Content**/}
          <p className="text-bodyclr dark:text-darkmuted font-medium text-sm py-4">{post?.data.content}</p>
          {/**If Post has Image**/}
