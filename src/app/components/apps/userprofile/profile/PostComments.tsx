...
const PostComments = ({ comment, post }: CommentProps) => {
  ...
  return (
    <>
      <div className="p-4 bg-lightbg dark:bg-darkbody rounded-lg my-6">
        ...
        {/**Post Content**/}
        <p className="text-ld font-medium opacity-80 text-sm py-4">
          ...
          {comment?.data.replies.map((reply: ReplyProps) => {
            return (
              <div className="ps-4" key={reply.data.comment}>
                <div className="p-4 bg-lightbg dark:bg-darkbody rounded-lg mt-6">
                  <div className="flex items-center gap-3">
