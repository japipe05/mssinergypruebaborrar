            ...
            >
              <CardBox className="px-0 pb-0  text-center overflow-hidden">
                ...
                <div>
                  ...
                  <p className="text-xs text-bodyclr dark:text-darkmuted">{profile.role}</p>
                </div>
                <div className="flex justify-center gap-4 items-center border-t border-ld mt-4 pt-4 bg-lightbg pb-4 dark:bg-darkbody">
