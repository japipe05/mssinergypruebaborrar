      ...
      <div className="flex justify-center">
        <div className="lg:w-3/4 w-full">
          ...
          <OutlineCard className="shadow-none mt-[30px]">
            ...
            <div className="flex items-center mt-6">
              <div className="flex gap-3.5">
                <div className="flex justify-center h-12 w-12 rounded-md bg-lightbg dark:bg-darkbody items-center text-dark dark:text-white">
                  <IconPackage />
                </div>
                <div>
                  <p className="text-sm text-bodyclr dark:text-darkmuted">Current Plan</p>
              ...
              <div className="ms-auto">
                <Tooltip content="Add">
                  <IconCirclePlus
                    size={18}
                    className="text-dark dark:text-darkmuted cursor-pointer"
                  />
                </Tooltip>
              </div>
            </div>
          ...
          <OutlineCard className="shadow-none mt-[30px]">
            ...
            <div className="flex items-center mt-6">
              <div className="flex gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-dark dark:text-darkmuted">
                    *****2102
                  </p>
                </div>
              </div>
            ...
            <p className="text-sm text-bodyclr dark:text-darkmuted">If you updated your payment method, it will only be dislpayed here after your next billing cycle.</p>
