      ...
      <div className="grid grid-cols-12 gap-6">
          ...
          <OutlineCard className="shadow-none">
            ...
            <div className="flex items-center justify-between border-t border-ld pt-4">
              <div className="">
                ...
                <p className="text-sm text-bodyclr dark:text-darkmuted">Google auth app</p>
              </div>
        ...
        <div className="md:col-span-4 col-span-12">
          <CardBox>
            ...
            <p className="text-sm text-bodyclr dark:text-darkmuted -mt-1">
            ...
            <div className="flex gap-3.5 items-center mt-6">
              ...
              <div>
                ...
                <p className="text-sm text-bodyclr dark:text-darkmuted">London UK, Oct 23 at 1:15 AM</p>
              </div>
            ...
            <div className="flex gap-3.5 items-center border-t border-ld mt-2 pt-3">
              ...
              <div>
                ...
                <p className="text-sm text-bodyclr dark:text-darkmuted">Gujarat India, Oct 24 at 3:15 AM</p>
              </div>
              <IconDotsVertical size={18} className="cursor-pointer ms-auto text-dark dark:text-white" />
            </div>
