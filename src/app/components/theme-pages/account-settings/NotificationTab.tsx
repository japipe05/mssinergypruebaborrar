        ...
        <div className="lg:w-3/4 w-full">
          <OutlineCard className="shadow-none pb-0">
            ...
            <div className="my-4">
              ...
              />
              <small className="text-sm text-bodyclr dark:text-darkmuted">
                ...
                <div className="flex mb-6 items-center">
                  <div className="flex gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-bodyclr dark:text-darkmuted">{item.subtitle}</p>
                    </div>
                  </div>
          ...
          <OutlineCard className="mt-[30px] shadow-none ">
            ...
            <div className="flex items-center mt-6">
              <div className="flex gap-3.5">
                ...
                <div>
                  <p className="text-sm text-bodyclr dark:text-darkmuted">Time zone</p>
            ...
            <div className="flex items-center mt-5">
              <div className="flex gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-bodyclr dark:text-darkmuted">Browser Cookie</p>
                </div>
              </div>
              <div className="ms-auto">
