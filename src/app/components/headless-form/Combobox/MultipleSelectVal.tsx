    ...
    <div>
      <CardBox>
        ...
        >
          ...
          <ComboboxOptions
            anchor="bottom"
            className="origin-top border transition duration-200 ease-out border-border dark:border-darkborder data-[closed]:scale-95 data-[closed]:opacity-0 absolute z-10 mt-1 max-h-60 w-[var(--input-width)]  overflow-auto rounded-md bg-white dark:bg-darkgray py-1 text-base shadow-md dark:shadow-dark-md ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm empty:invisible"
          >
