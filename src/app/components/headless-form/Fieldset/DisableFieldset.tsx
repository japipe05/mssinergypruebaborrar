      ...
      <CardBox>
        ...
        <Fieldset className="space-y-6 rounded-xl bg-lightgray dark:bg-dark p-6" disabled>
          ...
          <Field>
            ...
            <Description className="text-bodyclr dark:text-darkmuted text-xs mt-1">
          ...
          <Field>
            ...
            <Description className="text-xs text-bodyclr dark:text-darkmuted mt-1">
              If you have a tiger, we'd like to know about it.
            </Description>
            <Textarea className="ui-form-control rounded-md mt-3" rows={3} />
          </Field>
        </Fieldset>
      </CardBox>
    </div>
