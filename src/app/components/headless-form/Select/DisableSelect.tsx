...
const DisabledSelect = () => {
  return (
    ...
    <Field disabled>
          ...
          <Description className="mb-2 text-bodyclr dark:text-darkmuted font-medium text-xs data-[disabled]:opacity-50">This will be visible to clients on the project.</Description>
          <Select
            name="status"
        ...
        <Field disabled>
          ...
          <Description className="mb-2 text-bodyclr dark:text-darkmuted font-medium text-xs data-[disabled]:opacity-50">
