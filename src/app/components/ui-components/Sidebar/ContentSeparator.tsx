...
const ContentSeparator = () => {
  return (
    ...
    <Sidebar aria-label="Sidebar with content separator example" className="bg-darkgray dark:bg-darkgray p-4">
          <Sidebar.Items>
            <Sidebar.ItemGroup>
              <Sidebar.Item
                href="#"
              ...
              <Sidebar.Item href="#" icon={() => <IconBrandTrello size={20} className="me-3" />}>
                Kanban
              </Sidebar.Item>
            ...
            <Sidebar.ItemGroup>
              <Sidebar.Item href="#" icon={() => <IconWorldUpload size={20} className="me-3" />}>
                Upgrade to Pro
              </Sidebar.Item>
              <Sidebar.Item href="#" icon={() => <IconFileText size={20} className="me-3" />}>
                Documentation
              </Sidebar.Item>
              <Sidebar.Item
                href="#"
