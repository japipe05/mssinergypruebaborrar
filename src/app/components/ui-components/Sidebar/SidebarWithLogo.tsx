...
const SidebarWithLogo = () => {
  return (
    ...
    <Sidebar aria-label="Sidebar with logo branding example" className="bg-darkgray dark:bg-darkgray">
          <div className="pb-5">
            <FullLogo />
          </div>
          <Sidebar.Items>
        ...
        <Sidebar aria-label="Sidebar with logo branding example">
          <div className="p-5 bg-white dark:bg-darkgray">
            <FullLogo />
          </div>
          <Sidebar.Items  className="bg-darkgray dark:bg-darkgray p-4" >
            <Sidebar.ItemGroup>
              <Sidebar.Item
                href="#"
                icon={() => <IconLayoutDashboard size={20} className="me-3" />}
